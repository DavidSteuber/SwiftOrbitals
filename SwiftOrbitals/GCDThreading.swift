...
final class GCDThreading {
    ...
    private struct S {
        ...
        static let serialQueue = dispatch_queue_create("com.david-steuber.serial.queue", DISPATCH_QUEUE_SERIAL)
    ...
    class func runTimes(iterations: Int, block: ((count: Int) -> Void)) {
